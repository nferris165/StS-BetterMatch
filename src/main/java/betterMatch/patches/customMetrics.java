    ...
    private void sendPost()
    {
        ...
        Gdx.net.sendHttpRequest(httpRequest, new Net.HttpResponseListener()
        {
            public void handleHttpResponse(Net.HttpResponse httpResponse) {
                BetterMatch.logger.info("Metrics: http request response: " + httpResponse.getResultAsString());
            }

            public void failed(Throwable t) {
                BetterMatch.logger.info("Metrics: http request failed: " + t.toString());
            }

            public void cancelled() {
                BetterMatch.logger.info("Metrics: http request cancelled.");
            }
        });
    }
